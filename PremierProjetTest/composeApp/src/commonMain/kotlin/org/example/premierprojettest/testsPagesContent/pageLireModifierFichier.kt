...
import org.example.premierprojettest.getBoutonModifierFichier
import org.example.premierprojettest.getTextLectureFichier

@Composable
fun PageLireModifierFichier() {
    ...
    Column(
        ...
        getTextLectureFichier(toUpdate)()
        Box(
            modifier = Modifier
                .fillMaxHeight()
                .fillMaxWidth()
